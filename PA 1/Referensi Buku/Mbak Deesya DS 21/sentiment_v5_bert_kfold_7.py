# -*- coding: utf-8 -*-
"""sentiment_v5-bert-kfold-7

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZcWROkfAieIXmScb97tVes_VSNP_YuRN
...
df = pd.read_excel('/content/drive/MyDrive/sentimen-bert-try/training-dataset.xlsx')
...
training_args = TrainingArguments(
    output_dir="sentiment-bert-kfold5",
...
trainer.save_model('/content/drive/MyDrive/sentimen-bert-try/sentiment-v5-kfold-7')
...
comment = pipeline("sentiment-analysis", model="/content/drive/MyDrive/sentimen-bert-try/sentiment-v5-kfold-3")
